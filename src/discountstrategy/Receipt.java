...
//    private double totalDue;
    ...
    public void completeTransation() {
        output.printHeaderOnReceipt(receiptHeaderMessage, custID, receiptNo);
        output.printLineItemsOnReciept(lineItems);
        output.printFooterOnReceipt(receiptFooterMessage);
    }
